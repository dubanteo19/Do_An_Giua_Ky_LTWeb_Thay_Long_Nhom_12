...
<section id="contact" class="contact">
    <div class="container" data-aos="fade-up">
        ...
        <div class="row mt-3">
            <div class="col-lg-6">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3918.1986922460583!2d106.78813967481935!3d10.872487157414945!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3175276398969f7b%3A0x9672b7efd0893fc4!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBOw7RuZyBMw6JtIFRQLiBI4buTIENow60gTWluaA!5e0!3m2!1svi!2s!4v1698586770520!5m2!1svi!2s" width="600" height="750" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
            <div class="col-lg-6 ">
                <div class="content-menu px-3 bg-footer ">
                    <div class="title-head d-flex">
                        <h4 class="font-weight-bold text-primary-green text-center pt-3">Cửa hàng Lương thực việt</h4>
                ...
                <div class="content-menu mt-4 px-3 bg-footer">
                    <div class="title-head d-flex">
                        <h4 class="font-weight-bold text-primary-green text-center pt-3">Liên hệ với chúng tôi</h4>
                        <img class="leaf-store" src="images/logo/leaf.png" alt="" style="left: 245px!important;">
                    </div>
                    <form action="" method="post" role="form" class="php-email-form ">
                        ...
                        <div class="text-center pb-3"><button type="submit">Gửi thông tin</button></div>
                    </form>
                </div>
                </div>
            </div>
