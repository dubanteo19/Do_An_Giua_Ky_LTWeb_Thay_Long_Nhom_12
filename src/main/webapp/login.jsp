                            ...
                            <div class="page-login clearfix">
                                <div class="wpx">
                                    ...
                                    <div id="login" class="section">
                                        <form method="post" id="customer_login" accept-charset="UTF-8"><input name="FormType" type="hidden" value="customer_login">
                                            </span>
                                            <div class="form-signup clearfix">
                                                ...
                                                <div class="pull-xs-left justify-content-center text-center">
                                                    <button type="submit" value="" class="btn btn-green w-100 my-2" style="color: #fff">Đăng nhập</button>
                                    ...
                                    <div class="block social-login--facebooks pt-3" style="justify-items: center; text-align: center">
                                        <p>Không có tài khoản? <a href="signup.html" id="register-link">Đăng ký</a></p>
                                        <p class="text-center">
                                            Hoặc đăng nhập bằng
                                        </p>
...
function login() {
    ...
    var user = fakeDataBase.findUserByUsername(username);
    console.log(user);
    if (user != null) {
        if (user.password === password) {
            ...
            setTimeout(function() {
                ...
                window.location.href = getURL(user);
            }, 2000);
        } else {
            errorMessageElement.text('Sai mật khẩu. Vui lòng thử lại.');
        }
    } else {
        errorMessageElement.text('Emai chưa đăng ký! Vui lòng đăng ký.');
    }
}
