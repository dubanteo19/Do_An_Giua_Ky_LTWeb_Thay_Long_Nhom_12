...
<body>
  	<jsp:include page="Components/header.jsp" />
		...
		<jsp:param name="title" value="Sản phẩm bán chạy" />
	</jsp:include>
                            ...
                            <aside class="col-md-3 mb-child-20">
                                ...
                                <div class="aside-content bg-light-green">
                                    ...
                                    <div class="input-group flex-column price-filter">
                                        ...
                                        <input class="input-box" type="number" name="min-price" id="min-price" placeholder="Nhập số tiền tối thiểu">
                                        <label for="max-price">Tối đa</label>
                                        <input class="input-box" type="number" name="max-price" id="max-price" placeholder="Nhập số tiền tối đa">
                                    </div>
                                </div>
                                <!-- Thương hiệu -->
                                <!-- Trọng lượng -->
                                <div class="aside-content bg-light-green">
                                    <div class="title-head text-primary-green my-2">Trọng lượng</div>
                                    <div class="scroll">
                                        <div class="form-group">
                                            <div class="form-check">
                                                <label for="90g">1 ký</label>
                                                <input type="checkbox" name="90g" id="90g" class="form-check-input">
                                            </div>
                                            <div class="form-check">
                                                <label for="220g">10 ký</label>
                                                <input type="checkbox" name="220g" id="220g" class="form-check-input">
                                            </div>
                                            <div class="form-check">
                                                <label for="250g">100 ký</label>
